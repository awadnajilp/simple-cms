...
<?php if (isset($_GET['succ'])) {?>
			...
			<form class="form-horizontal" method="POST" action="page-edit-action.php"  enctype="multipart/form-data">
				<div class="box span9">
					...
					<input type="hidden" name="page_id" value="<?php echo $page_id;?>">
						  <fieldset style="padding-right:20px;padding-left:-10px">
							...
							<input type="hidden" name="post_type" value="<?php echo $recordset->featured_img;?>">
							...
							<div class="control-group">
							  ...
							  <label class="control-label" for="textarea2">File Uploads</label>
								<div class="controls"><?php $sql = "select * from uploads where belongs_to=$recordset->id and post_type='page' and type<>'jpg'";
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						...
						<?php $sql = "select * from uploads where belongs_to=$recordset->id and post_type='page' and type='jpg'";
								$query = mysql_query($sql);
								$count_uploads = mysql_num_rows($query);
								if($count_uploads > 0): while($result = mysql_fetch_object($query)):?>
								<li id="<?php echo $result->id;?>" class="thumbnail">
